    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          <motion.aside
            className="fixed inset-y-0 right-0 z-[11001] flex h-screen min-h-[100svh] w-full max-w-[95vw] flex-col overflow-hidden border-l border-white/12 bg-ah-black/95 px-6 pb-[calc(env(safe-area-inset-bottom,0px)+20px)] pt-[calc(env(safe-area-inset-top,0px)+20px)] shadow-[0_0_0_1px_rgba(255,255,255,.06),0_28px_90px_rgba(0,0,0,.6)] sm:max-w-sm"
